...
import std/[os, algorithm, unicode, critbits, options, strformat]
...
const
  ...
  Header = "# The Algorithms — Nim: Directory\n"
...
func canonicalize(s: string): string =
  ...
  ## collects them in the result. Consecutive whitespace gets merged.
...
func extractTitle(s: string): Option[string] =
  ## Reads the title of the file from it's first line if it's a doc comment.
  var s = s.strip()
  if s.startsWith("##"):
...
proc readLn(fname: string): Option[string] =
